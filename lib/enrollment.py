...
class Student:
    def __init__(self, name):
        self.name = name
        self._enrollments = []
        self._grades = {}  # Assuming grades are stored as {course_title: grade}
    ...
    def add_grade(self, course, grade):
        if isinstance(course, Course) and isinstance(grade, (int, float)):
            self._grades[course.title] = grade
        else:
            raise TypeError("course must be an instance of Course and grade must be a number")
